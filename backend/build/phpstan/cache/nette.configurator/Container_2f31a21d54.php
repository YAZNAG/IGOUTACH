...
class Container_2f31a21d54 extends _PHPStan_02959ca10\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_2f31a21d54 $container)
			{
	...
	public function createServiceContainer(): Container_2f31a21d54
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'BAGGAGE' => 'sentry-environment=production,sentry-release=Claude%401.24012.9,sentry-public_key=2f98127cbffe4740b1f767a2de77d23b,sentry-trace_id=555124c1cec947a08a025368e4bfec19,sentry-org_id=1158394',
				'CHROME_CRASHPAD_PIPE_NAME' => '\\\.\pipe\crashpad_23004_CSMNUVZLGDDCSXAY',
				'CLAUDECODE' => '1',
				...
				'SENTRY-TRACE' => '555124c1cec947a08a025368e4bfec19-84ede2a31cf851d6',
